...
<head>
    ...
    <link rel="stylesheet" href="bucket01-gz-20260606-001.oss-cn-guangzhou-internal.aliyuncs.com/css_login/style.css">
	<title>登录界面</title>
	</head>
<body>
...
<form method="post" action="login.php" class="content">
    ...
    <script src="http://bucket01-gz-20260606-001.oss-cn-guangzhou.aliyuncs.com/js/script.js"></script>
